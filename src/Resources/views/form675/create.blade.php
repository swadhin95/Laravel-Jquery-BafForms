...
@section('content')
    <div class="card my-5">
        <div class="card-header">
            <h5>Form-675 : Create</h5>
        </div>
        <form action="{{ route('form675.store') }}" method="post">@csrf
        <div class="card-body">
                    ...
                    <tr> 
                        <td>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-7">
                                    <input type="text" name="unit_flt_sec_name" class="form-control">
                                </div>
                            </div>
                        </td>
                        <td align="center">
                        ...
                        <td>
                            <div class="form-group row">
                                ...
                                <div class="col-6">
                                    <input type="text" name="receipt_voucher_no" class="form-control">
                                </div>
                            </div>
                            <div class="form-group row">
                    ...
                    <table style="width: 100%;">
                            <tr>
                                ...
                                <table style="width: 100% !important;">
                                        ...
                                        <tr>
                                            <td  style="margin-top: 10px; text-align: center;"><br>
                                                Name : <input type="text" name="name_of_user"> <br>
                                                Rank : <input type="text" name="rank" class="mt-1">
                                            </td>
                                        </tr>
                                        <tr>
                                ...
                                <table style="width: 100% !important;" align="center">
                                        <tr>
                                            <td  style="margin-top: 10px;"><br>
                                                Signature : <input type="text" name="recipient_signature"> <br>
                                                Date :  <input type="date" name="recipient_date" class="mt-1">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="center" style="border-top: 2px dotted black;">
                                        ...
                                        <tr>
                                            <td style="margin-top: 10px; text-align: center;">
                                                <input type="text" name="consent_of_returner_deposit_amount" class="mt-3">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="center" style="border-top: 2px dotted black;">
                                ...
                                <table class="table" style="width: 100% !important;" align="right">
                                        ...
                                        <tr>
                                            <td>
                                                <input type="text" class="form-control" name="sign_of_recorded_stock">
                                            </td>
                                            <td>
                                                <input type="date" class="form-control" name="date_of_recorded_stock">
                                            </td>
                                            <td>
                                                <input type="text" class="form-control" name="sign_of_corrected_ledger">
                                            </td>
                                            <td>
                                                <input type="date" class="form-control" name="date_of_corrected_ledger">
                                            </td>
                                        </tr>
                                    </table>
                                </td>
