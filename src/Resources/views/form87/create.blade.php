...
@section('content')
    <div class="card my-5  container-fluid">
        <div class="card-header">
            <h5>FORM-87: Create</h5>
        </div>
        <form action="{{ route('form87.store') }}" method="post">@csrf
            <div class="card-body">
                <div class="row">
                ...
                <div class="row" style="padding:55px 0 20px 0 ">
                    ...
                    <div class="col-sm-4 col-md-4 col-lg-4">
                        <input type="text" name="serial_no" size="35">
                    </div>
                    <div class="col-sm-2 col-md-2 col-lg-2">
                        <p>Date:</p>
                    </div>
                    <div class="col-sm-4 col-md-4 col-lg-4">
                        <input type="date" name="serial_date">
                    </div>
                    <div class="col-sm-2 col-md-2 col-lg-2">
                        <p>Voucher No:</p>
                    </div>
                    <div class="col-sm-4 col-md-4 col-lg-4">
                        <input type="text" name="voucher_no" size="35">
                    </div>
                    <div class="col-sm-2 col-md-2 col-lg-2">
                        <p>Date:</p>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-6">
                        ...
                        <input type="text" name="area_section">
                ...
                <table style="width: 100%; border: 1px; margin-top: 15px; margin-bottom: 35px;"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="section_no[]"></td>
                            <td><input type="text" name="part_no[]"></td>
                            <td><input type="text" name="details[]"></td>
                            <td><input type="text" name="stock_workable[]"></td>
                            <td><input type="text" name="stock_base_repairable[]"></td>
                            <td><input type="text" name="stock_depo_repairable[]"></td>
                            <td><input type="text" name="stock_useless[]"></td>
                            <td><input type="text" name="quality_control_workable[]"></td>
                            <td><input type="text" name="quality_control_base_repairable[]"></td>
                            <td><input type="text" name="quality_control_depo_repairable[]"></td>
                            <td><input type="text" name="quality_control_useless[]"></td>
                            <td><input type="text" name="unclassified[]"></td>
                        </tr>
                ...
                <div class="row">
                    <div class="col-sm-6 col-md-6 col-lg-6">
                        <input type="text" name="officer_in_charge_sign">
                    </div>
                    <div class="col-sm-6 col-md-6 col-lg-6 text-end">
                        <input type="text" name="chief_inspection_officer_sign">
                    </div>
                    <div class="col-sm-6 col-md-6 col-lg-6">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 col-md-4 col-lg-4 text-end" style="padding-top: 10px">
                        <span>Signature  </span><input type="text" name="chief_technical_officer_sign"><br>
                        <p>Chief Inspection Officer/<br>Chief Technical Officer</p>                        
                    </div>
                    <div class="col-sm-8 col-md-8 col-lg-8" style="padding-top: 10px">
                        <span>Approved </span><input type="text" name="approved">
                    </div> 
                    <div class="col-sm-4 col-md-4 col-lg-4 text-end" style="padding-top: 10px">
                        <span>Signature  </span><input type="text" name="captain_sign"><br>
                        <p>Captain</p>                        
                    </div>
                    <div class="col-sm-12 col-md-12 col-lg-12" style="border-bottom:groove; padding-bottom:10px;">
                    </div>
                    ...
                    <div class="row" style=" border-bottom:groove; padding:0 0 10px 0;">
                        <div class="col-sm-4 col-md-4 col-lg-4">
                            <table class="table-bordered"
                                ...
                                <tr>
                                    <td><input type="text" name="bought_charge_sign"></td>
                                    <td><input type="date" name="bought_charge_date"></td>
                                </tr>
                            </table>
                        ...
                        <div class="col-sm-4 col-md-4 col-lg-4">
                            <table class="table-bordered"
                                ...
                                <tr>
                                    <td><input type="text" name="out_charge_sign"></td>
                                    <td><input type="date" name="out_charge_date"></td>
                                </tr>
                            </table>
                        ...
                        <div class="col-sm-4 col-md-4 col-lg-4">
                            <span>Date</span><input type="text" name="Bought_out_date">
                        </div>
                        <div class="col-sm-4 col-md-4 col-lg-4">
                            <span>Signature of Officer in charge Area/Section</span><input type="text" name="officer_in_charge_sign_area">
                        </div>
                        <div class="col-sm-4 col-md-4 col-lg-4">
                    ...
                    <div class="row" style=" border-bottom:groove; margin-top:10px padding:0 0 10px 0;">
                        <div class="col-sm-12 col-md-12 col-lg-12">
                            <table class="table-bordered" style="width: 100%; border:1px; margin-top: 15px;  text-align:center;">
                                ...
                                <tr>
                                    <td><input type="text" name="section_law_no"></td>
                                    <td><textarea  name="presentation_detail" rows="3" cols="110"></textarea></td>
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-6">
                            <table class="table-bordered"
                                ...
                                <tr>
                                    <td><input type="text" name="hander"></td>
                                    <td><input type="text" name="quarter"></td>
                                    <td><input type="date" name="pound"></td>
                                </tr>
                            </table>
                        ...
                        <div class="col-sm-5 col-md-5 col-lg-5">
                            <table class="table-bordered"
                                ...
                                <tr>
                                    <td><input type="text" name="recorded_sign"></td>
                                    <td><input type="date" name="recorded_date"></td>
                                </tr>
                            </table>
                        ...
                        <div class="col-sm-4 col-md-4 col-lg-4" style="padding:10px 0 0 0">
                            <span>Date</span><input type="date" name="recorded_date_bottom">
                        </div>
                        <div class="col-sm-4 col-md-4 col-lg-4" style="padding:10px 0 0 0">
                        </div>
                        <div class="col-sm-4 col-md-4 col-lg-4 text-center" style="padding:10px 0 0 0">
                            <input type="text" name="acting_officer_sign"><br>
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12" style="padding-top: 10px">
                        ...
                        <textarea  name="inspection_granted" rows="3" cols="140"></textarea>
                    </div>
                    <div class="col-sm-12 col-md-12 col-lg-12" style="padding-top: 10px">
                        <p>2. When and where the goods were delivered to the unit</p>
                        <textarea  name="when_where" rows="2" cols="140"></textarea>
                    </div>
                    <div class="col-sm-12 col-md-12 col-lg-12" style="padding-top: 10px">
                        <p>3. Payment details every last three years</p>
                        <textarea  name="Payment_details" rows="2" cols="140"></textarea>
                    </div>
                    ...
                    <div class="col-sm-4 col-md-4 col-lg-4 text-end" style="padding-top: 10px">
                        <span>Signature  </span><input type="text" name="officer_in_charge_bottom_sign"><br>
                    </div>
                    <div class="col-sm-4 col-md-4 col-lg-4 " style="padding-top: 10px">
                        <span>Date  </span><input type="date" name="officer_in_charge_bottom_date"><br>
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12">
                        <input type="text" name="serial_no_bottom" placeholder="Serial Number">
                    </div>
                    <div class="col-sm-12 col-md-12 col-lg-12" style="border-bottom:groove; padding-bottom:10px;">
                    </div>
